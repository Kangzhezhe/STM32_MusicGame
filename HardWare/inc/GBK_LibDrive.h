...
#define	FCS_SET       HAL_GPIO_WritePin(GPIOC,GPIO_PIN_13,GPIO_PIN_SET)     //片选信号 PC13
#define	FCS_CLR  	    HAL_GPIO_WritePin(GPIOC,GPIO_PIN_13,GPIO_PIN_RESET)   //片选信号 PC13

#define	FDI_SET       HAL_GPIO_WritePin(GPIOF,GPIO_PIN_11,GPIO_PIN_SET)      //数据输出 PF11
#define	FDI_CLR       HAL_GPIO_WritePin(GPIOF,GPIO_PIN_11,GPIO_PIN_RESET)    //数据输出 PF11

#define	FDO_IN        HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_2)   //数据输入 PB2


#define	FCLK_SET      HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0,GPIO_PIN_SET)   //数据时钟线  PB0
#define	FCLK_CLR      HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0,GPIO_PIN_RESET) //数据时钟线  PB0
...
#define	FCS_SET 		  GPIO_SetBits(GPIOC,GPIO_Pin_13)       //片选信号 PC13
#define	FCS_CLR 		  GPIO_ResetBits(GPIOC,GPIO_Pin_13)     //片选信号 PC13
